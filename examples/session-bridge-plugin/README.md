...
Requires PI WEB `^1.202609.1` with the plugin data-directory and session-messaging APIs; the native companion is tested with Pi 0.85.1. During unreleased development, install the locally built PI WEB tarball instead of the registry dependency.
